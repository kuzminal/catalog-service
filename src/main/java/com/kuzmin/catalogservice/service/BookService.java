package com.kuzmin.catalogservice.service;

import com.kuzmin.catalogservice.exception.BookAlreadyExistsException;
import com.kuzmin.catalogservice.exception.BookNotFoundException;
import com.kuzmin.catalogservice.model.Book;
import com.kuzmin.catalogservice.repository.BookRepository;
...
public class BookService {
    ...
    public Book editBookDetails(String isbn, Book book) {
        ...
        Book bookToUpdate = new Book(isbn, book.getTitle(), book.getAuthor(),
